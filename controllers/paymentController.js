...
exports.postPaymentDetails = async (req, res) => {
  try {
    ...
    const htmlForBuyer = pug.renderFile(`${__dirname}/emailTemplate.pug`, {
      ...
      description1: "Congratulations! Your payment has been successfully processed against your card " + paymentCardData.cardNumber + " for the ",
      description2: " tour. Your travel agent is "+ paymentRecord.sellerName +"Their contact number is "+seller.phone+". You can now enjoy your tour with us. Please feel free to contact us if you have any queries.",
    });
    ...
    const htmlForSeller = pug.renderFile(`${__dirname}/emailTemplate.pug`, {
      ...
      notiName: paymentRecord.tourName,
      description1: "Congratulations! Our customer " + paymentRecord.buyerName+" has purchased a package for ",
      description2: " tour. The Buyer contact number is "+ buyer.phone +". Give them the best service and get the best ratings to be in the top sellers. Please feel free to contact us if you have any queries.",
    });
